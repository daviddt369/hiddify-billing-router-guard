...
SIMPLE_FILES=(
    ...
    "panel/commercial/__init__.py"
    "panel/commercial/restapi/v2/telegram/__init__.py"
    "panel/commercial/restapi/v2/telegram/tgbot.py"
    "panel/commercial/telegrambot/__init__.py"
    "panel/commercial/telegrambot/Usage.py"
    "panel/commercial/telegrambot/admin.py"
    "panel/commercial/telegrambot/DefaultResponse.py"
    "panel/commercial/telegrambot/information.py"
