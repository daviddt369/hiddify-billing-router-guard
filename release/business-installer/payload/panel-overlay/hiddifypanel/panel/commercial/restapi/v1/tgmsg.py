...
from hiddifypanel.panel.commercial.telegrambot.runtime import prepare_telebot
...
def _telegram_bot():
    ...
    if not token:
        return None
    return prepare_telebot(telebot.TeleBot(token, num_threads=1, parse_mode="HTML"))
