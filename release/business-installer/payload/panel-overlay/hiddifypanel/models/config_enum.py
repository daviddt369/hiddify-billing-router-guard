...
class ConfigEnum(metaclass=FastEnum):
    ...
    telegram_bot_token = _StrConfigDscr(ConfigCategory.hidden, hide_in_virtual_child=True)
    telegram_webhook_domain = _StrConfigDscr(ConfigCategory.hidden, hide_in_virtual_child=True)
    telegram_payment_provider_token = _StrConfigDscr(ConfigCategory.hidden, hide_in_virtual_child=True)
    support_url = _StrConfigDscr(ConfigCategory.hidden, hide_in_virtual_child=True)
    telegram_welcome_message = _StrConfigDscr(ConfigCategory.hidden, hide_in_virtual_child=True)
    telegram_instruction_button_text = _StrConfigDscr(ConfigCategory.hidden, hide_in_virtual_child=True)
    telegram_instruction_message = _StrConfigDscr(ConfigCategory.hidden, hide_in_virtual_child=True)
    telegram_instruction_android = _StrConfigDscr(ConfigCategory.hidden, hide_in_virtual_child=True)
    telegram_instruction_ios = _StrConfigDscr(ConfigCategory.hidden, hide_in_virtual_child=True)
    telegram_instruction_windows = _StrConfigDscr(ConfigCategory.hidden, hide_in_virtual_child=True)
    telegram_subscription_expiry_reminder_days = _StrConfigDscr(ConfigCategory.hidden, hide_in_virtual_child=True)
    telegram_subscription_expiry_reminder_message = _StrConfigDscr(ConfigCategory.hidden, hide_in_virtual_child=True)
    telegram_api_proxy_enable = _BoolConfigDscr(ConfigCategory.hidden, hide_in_virtual_child=True)
    telegram_api_proxy_url = _StrConfigDscr(ConfigCategory.hidden, hide_in_virtual_child=True)
    business_enabled = _BoolConfigDscr(ConfigCategory.hidden, ApplyMode.nothing, hide_in_virtual_child=True)
    commercial_routing_installed = _BoolConfigDscr(ConfigCategory.hidden, ApplyMode.nothing, hide_in_virtual_child=True)
    commercial_antishare_installed = _BoolConfigDscr(ConfigCategory.hidden, ApplyMode.nothing, hide_in_virtual_child=True)
