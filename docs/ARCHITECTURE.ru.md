...
│  │  ├── управление upstream-нодами (VLESS, Trojan)       │       │
...
- **Управление upstream-нодами** — ноды VLESS и Trojan хранятся в таблице `commercial_routing_upstream`; управляются через UI `RoutingAdmin`.
